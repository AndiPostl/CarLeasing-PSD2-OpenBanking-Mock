...
1. **1. Get Mock Token** (Auth) – mock only; for real API use your OAuth2 flow.
2. **2. Create consent** (Consents) – body: `access.allPsd2`, `validUntil: 2026-12-31` (matches `run-e2e-loan-flow.sh`).
3. **3. Simulate approval** (Mock – Simulate PSU approval) – sets consent to valid.
4. **4. Get consent** (Consents) – verify status is `valid`.
5. **5. Get loan list** (Loans) – then **6. Get loan details**, **7. Get loan balances**, **8. Get loan transactions**.
9. **9. Delete consent** (Consents) – optional.
